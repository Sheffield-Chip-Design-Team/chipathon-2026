...
│   ├── receiver.py   # DSP stages (MRC, ALMMSE, Weight computation)
│   └── stages.py     # Energy detector and Correlator bank
└── tests/            # Verification and analysis scripts
    ...
    └── test_correlator.py # Correlator bank functional tests
```
...
- **DSP Chain:** The signal chain follows the ASIC specification:
  1. ADC (Stage 1)
  2. ΣΔ Decimator (Stage 2)
  3. Energy Detector (Stage 3)
  4. Correlator Bank (Stage 4)
  5. Weight Computation/Combining (Stages 5-7)
